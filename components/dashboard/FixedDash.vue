            ...
            <v-sheet  elevation="3" rounded="lg">
                ...
                <v-tabs-window v-model="tab">
                  <v-tabs-window-item value="fixed_dash" id="tabs-window">
                    ...
                    <v-toolbar flat class="mt-4" border density="comfortable" color="#104666">
                            ...
                            <v-card>
                              <v-row>
                                ...
                                <v-col cols="9">
                                  ...
                                  <v-card-subtitle>Current Quarter Performance</v-card-subtitle>
                                </v-col>
                              </v-row>
                            ...
                            <v-card>
                              <v-row>
                                ...
                                <v-col cols="9">
                                  ...
                                  <v-card-subtitle>Weekly Overview</v-card-subtitle>
                                </v-col>
                              </v-row>
